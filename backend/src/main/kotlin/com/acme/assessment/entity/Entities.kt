package com.acme.assessment.entity
...
enum class UserStatus { PENDING_APPROVAL, ACTIVE, LOCKED, DISABLED }
...
class User(
    ...
    var dingtalkUserId: String? = null,
    @Column(name = "dingtalk_name")
    var dingtalkName: String? = null,
    @Column(name = "dingtalk_matched_mobile")
    var dingtalkMatchedMobile: String? = null,
    @Column(name = "dingtalk_match_status")
    var dingtalkMatchStatus: String = "PENDING",
    @Column(name = "dingtalk_matched_at")
    var dingtalkMatchedAt: Instant? = null,
    @Column(name = "dingtalk_last_error")
    var dingtalkLastError: String? = null,
...
class AssessmentTask(
    ...
    var finalConclusion: ReviewConclusion? = null,
    @Column(name = "final_conclusion_at")
