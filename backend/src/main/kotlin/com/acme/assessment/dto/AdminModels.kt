...
data class CreateUserRequest(
    ...
    @field:Positive val positionId: Long? = null,
...
data class UserResponse(
    ...
    val dingtalkUserId: String? = null,
    val dingtalkName: String? = null,
    val dingtalkMatchStatus: String = "PENDING",
)
...
data class CreateTemplateVersionRequest(
    @field:NotBlank val schemaJson: String,
)
